...
require "../backend/admin_hackathon/update_hackathon.php";
?>
                ...
                <div class="col-md-12">
                    <div class="card mt-5">
                        <div class="card-header">
                            <h2>Update Hackathon</h2>
                            <p>Please fill this form and submit to update hackathon record in the database.</p>
                        </div>
                        <div class="card-body">
                            <form action="update_hackathon.php" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                ...
                                <input type="hidden" name="hackathon_id" value="<?php echo $id; ?>" />
