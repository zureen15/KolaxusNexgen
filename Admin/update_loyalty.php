<?php
require '../backend/admin_loyalty/update_loyalty.php';
?>
                ...
                <div class="col-md-12">
                    <div class="card mt-5">
                        <div class="card-header">
                            <h2>Update Voucher or Discount</h2>
                            <p>Please fill this form and submit to update loyalty program record in the database.</p>
                        </div>
                        <div class="card-body">
                            <form action="update_loyalty.php" method="post" enctype="multipart/form-data">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php if (!empty($image)): ?>
                                            <img src="upload/<?php echo $image; ?>" alt="Current Image"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" id="expiry_date" name="expiry_date"
                                            class="form-control <?php echo (!empty($expiry_err)) ? 'is-invalid' : ''; ?>"
