...
require "../backend/admin_challenge/create_challenge.php";
...
<head>
    ...
    <title>Create Challenge Program</title>
                ...
                <div class="col-md-12">
                    <div class="card mt-5">
                        <div class="card-header">
                            ...
                            <p>Please fill this form and submit to add challenge program to the database.</p>
                        </div>
                        <div class="card-body">
                            <form action="create_challenge.php" method="post" enctype="multipart/form-data">
                                <div class="form-row">
