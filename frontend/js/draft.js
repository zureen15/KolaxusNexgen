...
//     const startUniversityInput = document.getElementById('start-university');
//     const finishUniversityInput = document.getElementById('finish-university');

//     // Ensure the new fields are validated
...
//     startUniversityInput.addEventListener('input', function () {
//         if (!startUniversityInput.value) {
//             startUniversityInput.setCustomValidity('Please select your start university date.');
//         } else {
//             startUniversityInput.setCustomValidity('');
//         }
//     });

//     finishUniversityInput.addEventListener('input', function () {
//         if (!finishUniversityInput.value) {
//             finishUniversityInput.setCustomValidity('Please select your finish university date.');
//         } else {
//             finishUniversityInput.setCustomValidity('');
//         }
//     });
// });
...
form.addEventListener("submit", (e) => {
    ...
    // const studentIdImage = document.getElementById('student-id').files[0];
    // const startDate = document.getElementById('start-university').value;
    // const endDate = document.getElementById('finish-university').value;
    ...
    // formData.append('student-id', studentIdImage);
    // formData.append('start-university', startDate);
    // formData.append('finish-university', endDate);
