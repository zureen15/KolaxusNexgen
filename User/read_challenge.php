<?php
require '../backend/user/read_challenge.php';
?>
        ...
        <main class="pull-left">
            <div class="col-md-12">
                <div class="container mt-5">
                    <h1 class="pull-left"><?php echo $program_name; ?></h1>
                    <section class="details">
                            ...
                            <div class="col-md-12">
                                <div>
                                    ...
                                    foreach ($images as $img) {
                                        echo '<img src="../Challenge/upload/' . htmlspecialchars($img, ENT_QUOTES, 'UTF-8') . '" alt="Image" width="150" height="150" class="challenge-image">';
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <p><strong>Type:</strong> <?php echo $challenge_type; ?></p>
                                <p><strong>Location:</strong>
                                    <?php
                                    if ($challenge_type === 'Online') {
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                <button class="btn join-btn" data-challenge-id="<?php echo $param_id; ?>">Join
                                    Challenge</button>
                            </div>
                        </div>
                    </section>
